...
(`stargraph.bosun.*`). They're regular Fathom rule packs, mounted on graphs
declaratively.
...
`/stargraph:new-pack --flavor routing` and mount via `rules:`.

## Authoring a new pack

Use `/stargraph:new-pack <name> --flavor routing|governance`. It scaffolds:
...
`pack.yaml` declares the public fact vocabulary (templates) and which Stargraph
