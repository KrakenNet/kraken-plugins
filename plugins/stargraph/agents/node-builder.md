---
description: Add a typed node to a Stargraph graph; manage state-sync boundary; update graph hash.
...
1. Add a node spec to `graphs/<graph>/stargraph.yaml`.
...
5. `uv run stargraph graph verify graphs/<graph>/stargraph.yaml`.
